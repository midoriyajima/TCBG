...
por_data <- readxl::read_excel(
  here::here("Data", "Input", "Porometry_MY.xlsx"), 
  skip = 1,
  col_types = c("date", "numeric", "numeric", "text","text", "numeric", "numeric", "numeric"))

por_meta <- readxl::read_excel(
  here::here("Data", "Input", "Porometry_metadata_MY.xlsx"))

pm_meta <- readxl::read_excel(
  here::here("Data", "Input", "PM_metadata_MY.xlsx"))

herb_data <- read.csv(
  here::here("Data", "Input", "Herbarium_MY.csv"))
